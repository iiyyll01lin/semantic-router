...
| P1 | EXAONE 4.0 32B | `ingu627/exaone4.0:32b` | 11.1 | 19.4 | timeout/no JSON | 0.078 | partial | quality pass exceeded capped runner or produced no JSON |
...
| P1/P2 | Phi-4 reasoning plus | `phi4-reasoning:plus` | 19.8 | 11.6 | timeout/no JSON | 0.139 | partial | quality pass exceeded capped runner or produced no JSON |
...
- EXAONE/OpenThinker/Magistral/Phi quality: speed and power captured, but no quality JSON under the capped P1/P2 runner; EXAONE is also research-only/non-commercial and not default-eligible.
